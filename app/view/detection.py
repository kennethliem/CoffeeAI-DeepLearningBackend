    ...
    if os.path.isfile(path_name):
        if request.method == "POST":
            ...
            if request.files.get("image"):
                ...
                image = tf.keras.preprocessing.image.load_img(io.BytesIO(
                    image), target_size=(240, 240), color_mode="grayscale")
        ...
        data["error"] = True
        data["message"] = "Engine Offline, Please Contact service@coffeeai.online"
